...
import org.springframework.boot.jetty.autoconfigure.actuate.web.server.JettyServletManagementContextAutoConfiguration;
...
public class HawtioSpringBootTestSupport {
    ...
    @BeforeEach
    public void setUp() {
        contextRunner = new WebApplicationContextRunner(AnnotationConfigServletWebServerApplicationContext::new)
            .withConfiguration(AutoConfigurations.of(
                    ...
                    JettyServletManagementContextAutoConfiguration.class,
    ...
    protected WebTestClient getTestClient(AssertableWebApplicationContext context, boolean followRedirects) {
        ...
        if (port == null) {
            port = Objects.requireNonNull(context.getSourceApplicationContext(AnnotationConfigServletWebServerApplicationContext.class).getWebServer()).getPort();
        }
