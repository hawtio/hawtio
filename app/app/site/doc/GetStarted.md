...
<a class="btn btn-large  btn-primary" href="https://oss.sonatype.org/content/repositories/public/io/hawt/hawtio-app/1.5.6/hawtio-app-1.5.6.jar">Download the executable hawtio-app-1.5.6.jar</a>
...
Note: If you launch hawt.io with Java 9, add the specified modules to avoid errors on startup and allow attaching to other Java processes:
    ...
    java --add-modules jdk.attach,java.xml.bind -jar hawtio-app-1.5.6.jar
...
<div class="row">
  <div class="col-md-6 span6 text-center">
    <p>
      <a class="btn btn-large  btn-primary" href="https://oss.sonatype.org/content/repositories/public/io/hawt/hawtio-default/1.5.6/hawtio-default-1.5.6.war">Download hawtio-default.war</a>
    </p>
    <p>
  ...
  <div class="col-md-6 span6 text-center">
    <p>
      <a class="btn btn-large  btn-primary" href="https://oss.sonatype.org/content/repositories/public/io/hawt/hawtio-default-offline/1.5.6/hawtio-default-offline-1.5.6.war">Download hawtio-default-offline.war</a>
    </p>
    <p>
  ...
  <div class="col-md-6 span6 text-center">
    <p>
      <a class="btn btn-large  btn-primary" href="https://oss.sonatype.org/content/repositories/public/io/hawt/sample/1.5.6/sample-1.5.6.war">Download sample.war</a>
    </p>
    <p>
...
Otherwise you will need to use either [http://localhost:8080/hawtio-default-1.5.6/](http://localhost:8080/hawtio-default-1.5.6/) or [http://localhost:8080/sample-1.5.6/](http://localhost:8080/sample-1.5.6/)  depending on the file name you downloaded.
...
If you are using [Apache Karaf](http://karaf.apache.org/) 2.x:
    ...
    features:chooseurl hawtio 1.5.6
...
You may have issues with slf4j JARs in WAR deployments on JBoss AS or Wildfly. To resolve this you must use <a class="btn-default" href="https://oss.sonatype.org/content/repositories/public/io/hawt/hawtio-no-slf4j/1.5.6/hawtio-no-slf4j-1.5.6.war">Download hawtio-no-slf4j.war</a>.
