...
public interface IdeFacadeMBean {
     ...
     */
    String findClassAbsoluteFileName(String className, String fileName, List<String> sourceRoots);

    /**
     * Open an absolute file name in IDEA and navigate to the position in the file
     */
    String ideaOpenAndNavigate(String fileName, int line, int column) throws Exception;

    /**
     * Open an absolute file name in IDEA
     */
    String ideaOpen(String fileName) throws Exception;
}
