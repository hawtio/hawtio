...
var Sample = (function(Sample) {
   ...
   */
  Sample.pluginName = 'sample_plugin';
   ...
   */
  Sample.templatePath = Sample.contextPath + "html/";
   ...
   * run function
   */
  Sample.module = angular.module('sample_plugin', ['hawtioCore'])
      .config(function($routeProvider) {
        ...
        $routeProvider.
            when('/sample_plugin', {
              templateUrl: Sample.templatePath + 'sample.html'
            });
      });
   ...
   *     topLevelTabs array.
   */
  Sample.module.run(function(workspace, viewRegistry, layoutFull) {

    Sample.log.info(Sample.pluginName, " loaded");

    Core.addCSS(Sample.contextPath + "css/sample.css");

    // tell the app to use the full layout, also could use layoutTree
    // to get the JMX tree or provide a URL to a custom layout
    viewRegistry["sample_plugin"] = layoutFull;
    ...
    workspace.topLevelTabs.push({
      ...
      href: function() { return "#/sample_plugin"; },
      isActive: function(workspace) { return workspace.isLinkActive("sample_plugin"); }
