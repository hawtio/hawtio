...
It's a [pluggable](http://hawt.io/developers/plugins/index.html) management console for Java stuff which supports any kind of JVM, any kind of container (Tomcat, Jetty, Karaf, JBoss, Fuse Fabric, etc), and any kind of Java technology and middleware.
...
Check out [how plugins work](http://hawt.io/developers/plugins/index.html). You can then either:
