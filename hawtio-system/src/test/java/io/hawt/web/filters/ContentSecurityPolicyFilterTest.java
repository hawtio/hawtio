...
public class ContentSecurityPolicyFilterTest {
    ...
    public void shouldSetHeader() throws Exception {
        ...
        verify(response).addHeader("Content-Security-Policy",
            "default-src 'self'; script-src 'self'; "
                + "style-src 'self' 'unsafe-inline'; font-src 'self' data: https://cdn.jsdelivr.net/npm/monaco-editor@*/min/; img-src 'self' data:; "
                + "connect-src 'self'; frame-src 'self'; "
                + "manifest-src 'self'; media-src 'self'; object-src 'self'; worker-src 'self' blob:; "
                + "frame-ancestors 'none'; "
                + "script-src-elem 'self' https://cdn.jsdelivr.net/npm/monaco-editor@*/min/; "
                + "style-src-elem 'self' 'unsafe-inline' https://cdn.jsdelivr.net/npm/monaco-editor@*/min/");
    }
    ...
    public void shouldNotNPEWithBlankStringAsKeycloakConfigFile() throws Exception {
        ...
        verify(response).addHeader(eq("Content-Security-Policy"), eq(
            "default-src 'self'; script-src 'self'; "
                + "style-src 'self' 'unsafe-inline'; font-src 'self' data: https://cdn.jsdelivr.net/npm/monaco-editor@*/min/; "
