...
<a class="btn btn-large  btn-primary" href="https://oss.sonatype.org/content/repositories/public/io/hawt/hawtio-app/1.2.1/hawtio-app-1.2.1.jar">Download the executable hawtio-app-1.2.1.jar</a>
...
<table class="buttonTable">
  <tr>
    <td>
      <a class="btn btn-large  btn-primary" href="https://oss.sonatype.org/content/repositories/public/io/hawt/hawtio-default/1.2.1/hawtio-default-1.2.1.war">Download hawtio-default.war</a>
    </td>
    <td>
      <a class="btn btn-large  btn-primary" href="https://oss.sonatype.org/content/repositories/public/io/hawt/sample/1.2.1/sample-1.2.1.war">Download sample.war</a>
    </td>
  </tr>
  <tr>
    <td>
...
Otherwise you will need to use either [http://localhost:8080/hawtio-default-1.2.1/](http://localhost:8080/hawtio-default-1.2.1/) or [http://localhost:8080/sample-1.2.1/](http://localhost:8080/sample-1.2.1/)  depending on the file name you downloaded.
