...
<a class="btn btn-large  btn-primary" href="https://oss.sonatype.org/content/repositories/public/io/hawt/hawtio-app/1.5.5/hawtio-app-1.5.5.jar">Download the executable hawtio-app-1.5.5.jar</a>
...
<div class="row">
  <div class="col-md-6 span6 text-center">
    <p>
      <a class="btn btn-large  btn-primary" href="https://oss.sonatype.org/content/repositories/public/io/hawt/hawtio-default/1.5.5/hawtio-default-1.5.5.war">Download hawtio-default.war</a>
    </p>
    <p>
  ...
  <div class="col-md-6 span6 text-center">
    <p>
      <a class="btn btn-large  btn-primary" href="https://oss.sonatype.org/content/repositories/public/io/hawt/hawtio-default-offline/1.5.5/hawtio-default-offline-1.5.5.war">Download hawtio-default-offline.war</a>
    </p>
    <p>
  ...
  <div class="col-md-6 span6 text-center">
    <p>
      <a class="btn btn-large  btn-primary" href="https://oss.sonatype.org/content/repositories/public/io/hawt/sample/1.5.5/sample-1.5.5.war">Download sample.war</a>
    </p>
    <p>
...
Otherwise you will need to use either [http://localhost:8080/hawtio-default-1.5.5/](http://localhost:8080/hawtio-default-1.5.5/) or [http://localhost:8080/sample-1.5.5/](http://localhost:8080/sample-1.5.5/)  depending on the file name you downloaded.
...
If you are using [Apache Karaf](http://karaf.apache.org/) 2.x:
    ...
    features:chooseurl hawtio 1.5.5
    features:install hawtio

If you are using [Apache Karaf](http://karaf.apache.org/) 3.x:

    feature:repo-add hawtio 1.5.5
...
You may have issues with slf4j JARs in WAR deployments on JBoss AS or Wildfly. To resolve this you must use <a class="btn-default" href="https://oss.sonatype.org/content/repositories/public/io/hawt/hawtio-no-slf4j/1.5.5/hawtio-no-slf4j-1.5.5.war">Download hawtio-no-slf4j.war</a>.
