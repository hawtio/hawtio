...
Otherwise you will need to use either [http://localhost:8080/hawtio-default-1.4.22/](http://localhost:8080/hawtio-default-1.4.22/) or [http://localhost:8080/sample-1.4.22/](http://localhost:8080/sample-1.4.22/)  depending on the file name you downloaded.
