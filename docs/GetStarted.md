...
Note this extension is a little experimental until we cut 1.2.3; so please be gentle - here's now to get started:

<a class="btn btn-large  btn-primary" href="https://oss.sonatype.org/content/repositories/public/io/hawt/hawtio-app/1.2.2/hawtio-app-1.2.2.jar">Download the hawtio Chrome Extension for 1.0.1</a>
...
* now in <a href="https://www.google.com/intl/en/chrome/browser/">Google Chrome</a> open the <a class="btn btn-large" href="chrome://extensions/">Extensions Page</a>

* now drop the downloaded CRX file (from Finder or Windows Explorer) onto Chrome's <a href="chrome://extensions/">Extensions Page</a> and it should install the hawtio extension for Chrome.
...
<a class="btn btn-large  btn-primary" href="https://oss.sonatype.org/content/repositories/public/io/hawt/hawtio-app/1.2.2/hawtio-app-1.2.2.jar">Download the executable hawtio-app-1.2.2.jar</a>
...
hawtio supports other options which you can get listed by running from command line:
    ...
    java -jar hawtio-app-1.2.2.jar --help
...
<table class="buttonTable">
  <tr>
    <td>
      <a class="btn btn-large  btn-primary" href="https://oss.sonatype.org/content/repositories/public/io/hawt/hawtio-default/1.2.2/hawtio-default-1.2.2.war">Download hawtio-default.war</a>
    </td>
    <td>
      <a class="btn btn-large  btn-primary" href="https://oss.sonatype.org/content/repositories/public/io/hawt/sample/1.2.2/sample-1.2.2.war">Download sample.war</a>
    </td>
  </tr>
  <tr>
    <td>
...
Otherwise you will need to use either [http://localhost:8080/hawtio-default-1.2.2/](http://localhost:8080/hawtio-default-1.2.2/) or [http://localhost:8080/sample-1.2.2/](http://localhost:8080/sample-1.2.2/)  depending on the file name you downloaded.
...
If you are working offline and have no access to the internet on the machines you want to use with hawtio then you may wish to
 <a class="btn" href="https://oss.sonatype.org/content/repositories/public/io/hawt/hawtio-default-offline/1.2.2/hawtio-default-offline-1.2.2.war">Download hawtio-default-offline.war</a> which avoids some pesky errors appearing in your log on startup (as the default behaviour is to clone a git repo on startup for some default wiki and dashboard content).
...
If you are using [Apache Karaf](http://karaf.apache.org/) 2.3.3 or newer then you can use 'features:chooseurl' which is simpler to do:
    ...
    features:chooseurl hawtio 1.2.2
    features:install hawtio
