...
<a class="btn btn-large  btn-primary" href="https://oss.sonatype.org/content/repositories/public/io/hawt/hawtio-app/1.4.63/hawtio-app-1.4.63.jar">Download the executable hawtio-app-1.4.63.jar</a>

Once you have downloaded it, just run this from the command line:

    java -jar hawtio-app-1.4.63.jar
...
<div class="row">
  ...
  <div class="col-md-6 span6 text-center">
    <p>
      <a class="btn btn-large  btn-primary" href="https://oss.sonatype.org/content/repositories/public/io/hawt/sample/1.4.63/sample-1.4.63.war">Download sample.war</a>
    </p>
    <p>
...
Otherwise you will need to use either [http://localhost:8080/hawtio-default-1.4.63/](http://localhost:8080/hawtio-default-1.4.63/) or [http://localhost:8080/sample-1.4.63/](http://localhost:8080/sample-1.4.63/)  depending on the file name you downloaded.
...
You may have issues with slf4j JARs in WAR deployments on JBoss AS or Wildfly. To resolve this you must use <a class="btn-default" href="https://oss.sonatype.org/content/repositories/public/io/hawt/hawtio-no-slf4j/1.4.63/hawtio-no-slf4j-1.4.63.war">Download hawtio-no-slf4j.war</a>.
...
<a class="btn btn-large btn-primary" href="http://central.maven.org/maven2/io/hawt/hawtio-crx/1.4.63/hawtio-crx-1.4.63.crx">Download the hawtio Chrome Extension version 1.4.63</a>
