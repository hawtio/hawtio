...
<a class="btn btn-large  btn-primary" href="https://oss.sonatype.org/content/repositories/public/io/hawt/hawtio-app/1.3.1/hawtio-app-1.3.1.jar">Download the executable hawtio-app-1.3.1.jar</a>

Once you have downloaded it, just run this from the command line:

    java -jar hawtio-app-1.3.1.jar
...
hawtio supports other options which you can get listed by running from command line:
    ...
    java -jar hawtio-app-1.3.1.jar --help
...
<table class="buttonTable">
  <tr>
    <td>
      <a class="btn btn-large  btn-primary" href="https://oss.sonatype.org/content/repositories/public/io/hawt/hawtio-default/1.3.1/hawtio-default-1.3.1.war">Download hawtio-default.war</a>
    </td>
    <td>
      <a class="btn btn-large  btn-primary" href="https://oss.sonatype.org/content/repositories/public/io/hawt/sample/1.3.1/sample-1.3.1.war">Download sample.war</a>
    </td>
  </tr>
  <tr>
    <td>
...
Otherwise you will need to use either [http://localhost:8080/hawtio-default-1.3.1/](http://localhost:8080/hawtio-default-1.3.1/) or [http://localhost:8080/sample-1.3.1/](http://localhost:8080/sample-1.3.1/)  depending on the file name you downloaded.
...
If you are working offline and have no access to the internet on the machines you want to use with hawtio then you may wish to
 <a class="btn" href="https://oss.sonatype.org/content/repositories/public/io/hawt/hawtio-default-offline/1.3.1/hawtio-default-offline-1.3.1.war">Download hawtio-default-offline.war</a> which avoids some pesky errors appearing in your log on startup (as the default behaviour is to clone a git repo on startup for some default wiki and dashboard content).
...
Otherwise if you are using 6.0 or earlier of [Fuse](http://www.jboss.org/products/fuse) or a vanilla [Apache Karaf](http://karaf.apache.org/) or [Apache ServiceMix](http://servicemix.apache.org/) then try the following:
    ...
    features:addurl mvn:io.hawt/hawtio-karaf/1.3.1/xml/features
...
If you are using [Apache Karaf](http://karaf.apache.org/) 2.3.3 or newer then you can use 'features:chooseurl' which is simpler to do:
    ...
    features:chooseurl hawtio 1.3.1
    features:install hawtio
