...
* [hawtio-app-2.14.5.jar](https://repo1.maven.org/maven2/io/hawt/hawtio-app/2.14.5/hawtio-app-2.14.5.jar)
...
See [Spring Boot example](https://github.com/hawtio/hawtio/tree/hawtio-2.14.5/examples/springboot) for a working example app.
