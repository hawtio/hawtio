...
```console
jbang app install --name hawtio5 hawtio@hawtio/hawtio/5.x
hawtio5 --help
```
...
See [Spring Boot example](https://github.com/hawtio/hawtio/tree/hawtio-5.0-M1/examples/springboot) for a working example app.
...
See [Quarkus example](https://github.com/hawtio/hawtio/tree/hawtio-5.0-M1/examples/quarkus) for a working example app.
