...
* [hawtio-app-2.16.2.jar](https://repo1.maven.org/maven2/io/hawt/hawtio-app/2.16.2/hawtio-app-2.16.2.jar)

Once you have downloaded it, just run this from the command line:

    java -jar hawtio-app-2.16.2.jar
...
See [Spring Boot example](https://github.com/hawtio/hawtio/tree/hawtio-2.16.2/examples/springboot) for a working example app.

### Deploying on Apache Karaf

If you are using [Apache Karaf](https://karaf.apache.org/) 4.x and above:

    feature:repo-add hawtio 2.16.2
