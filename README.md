**hawt.io** is a lightweight and [modular](http://hawt.io/developers/plugins.html) HTML5 web console for managing your Java stuff. It's a _hawt_ console to help you stay cool!
...
**hawt.io** also supports [Health MBeans](http://hawt.io/health/) to make it easy for your Java services to expose their health status so you can see how your Java stuff is behaving.
...
### Installing hawt.io to [Apache Karaf](http://karaf.apache.org/)

You can install public releases of hawt.io using a vanilla [Apache Karaf](http://karaf.apache.org/), [Apache ServiceMix](http://servicemix.apache.org/) container, using the following commands:
...
Then opening [http://localhost:8080/hawtio/](http://localhost:8080/hawtio/) should show hawt.io with a sample web application with some ActiveMQ and Camel inside to interact with.
