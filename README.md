...
See [Spring Boot example](https://github.com/hawtio/hawtio/tree/hawtio-3.0.0-RC1/examples/springboot) for a working example app.
...
See [Quarkus example](https://github.com/hawtio/hawtio/tree/hawtio-3.0.0-RC1/examples/quarkus) for a working example app.
