...
See [Spring Boot example](https://github.com/hawtio/hawtio/tree/hawtio-4.6.2/examples/springboot) for a working example app.
...
See [Quarkus example](https://github.com/hawtio/hawtio/tree/hawtio-4.6.2/examples/quarkus) for a working example app.
