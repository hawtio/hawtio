...
* [hawtio-app-2.9.1.jar](https://repo1.maven.org/maven2/io/hawt/hawtio-app/2.9.1/hawtio-app-2.9.1.jar)
...
See [Spring Boot example](https://github.com/hawtio/hawtio/tree/hawtio-2.9.1/examples/springboot) for a working example app.
