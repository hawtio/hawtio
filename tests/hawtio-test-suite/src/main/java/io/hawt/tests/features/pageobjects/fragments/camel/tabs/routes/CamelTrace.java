...
public class CamelTrace extends CamelPage {
    ...
    public void traceTableIsShown() {
        $$(byClassName("route-message.table")).shouldHave(sizeGreaterThan(1));
    }
    ...
    public void traceDiagramIsShown() {
        $$(byClassName("camel-route-diagram")).shouldHave(sizeGreaterThan(1));
    }
    ...
    public void traceTableIsntShown() {
        $$(byClassName("route-message.table")).shouldHave(size(0));
    }
    ...
    public void traceDiagramIsntShown() {
        $$(byClassName("camel-route-diagram")).shouldHave(size(0));
    }
}
