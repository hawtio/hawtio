...
public class Config implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.hawt.v1.hawtiospec.config.About about;

    public io.hawt.v1.hawtiospec.config.About getAbout() {
        return about;
    }

    public void setAbout(io.hawt.v1.hawtiospec.config.About about) {
        this.about = about;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.hawt.v1.hawtiospec.config.Branding branding;

    public io.hawt.v1.hawtiospec.config.Branding getBranding() {
        return branding;
    }

    public void setBranding(io.hawt.v1.hawtiospec.config.Branding branding) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.hawt.v1.hawtiospec.config.Online online;

    public io.hawt.v1.hawtiospec.config.Online getOnline() {
        return online;
    }

    public void setOnline(io.hawt.v1.hawtiospec.config.Online online) {
        this.online = online;
    }
}
