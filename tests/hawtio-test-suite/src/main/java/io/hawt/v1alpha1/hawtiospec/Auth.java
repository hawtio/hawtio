...
public class Auth implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    /**
     * CronJob schedule that defines how often the expiry of the certificate will be checked. Client rotation isn't enabled if the schedule isn't set.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("clientCertCheckSchedule")
    @com.fasterxml.jackson.annotation.JsonPropertyDescription("CronJob schedule that defines how often the expiry of the certificate will be checked. Client rotation isn't enabled if the schedule isn't set.")
    ...
    /**
     * The duration in hours before the expiration date, during which the certification can be rotated. The default is set to 24 hours.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("clientCertExpirationPeriod")
    @com.fasterxml.jackson.annotation.JsonPropertyDescription("The duration in hours before the expiration date, during which the certification can be rotated. The default is set to 24 hours.")
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
