...
public class Route implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.hawt.v1alpha1.hawtiospec.route.CaCert caCert;

    public io.hawt.v1alpha1.hawtiospec.route.CaCert getCaCert() {
        return caCert;
    }

    public void setCaCert(io.hawt.v1alpha1.hawtiospec.route.CaCert caCert) {
        this.caCert = caCert;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.hawt.v1alpha1.hawtiospec.route.CertSecret certSecret;

    public io.hawt.v1alpha1.hawtiospec.route.CertSecret getCertSecret() {
        return certSecret;
    }

    public void setCertSecret(io.hawt.v1alpha1.hawtiospec.route.CertSecret certSecret) {
