...
public class Nginx implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    /**
     * The number and size of the buffers used for reading a response from the proxied server, for a single connection. Defaults to `16 128k`.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("proxyBuffers")
    @com.fasterxml.jackson.annotation.JsonPropertyDescription("The number and size of the buffers used for reading a response from the proxied server, for a single connection. Defaults to `16 128k`.")
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    ...
    /**
     * The size of the buffer used for storing the response body of a subrequest. Defaults to `10m`.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("subrequestOutputBufferSize")
    @com.fasterxml.jackson.annotation.JsonPropertyDescription("The size of the buffer used for storing the response body of a subrequest. Defaults to `10m`.")
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
