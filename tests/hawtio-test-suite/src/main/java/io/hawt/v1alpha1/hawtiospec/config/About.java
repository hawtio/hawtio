...
public class About implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    /**
     * The image displayed in the page. It can be a path, relative to the Hawtio status URL, or an absolute URL.
     */
    @com.fasterxml.jackson.annotation.JsonProperty("imgSrc")
    @com.fasterxml.jackson.annotation.JsonPropertyDescription("The image displayed in the page. It can be a path, relative to the Hawtio status URL, or an absolute URL.")
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
