describe("Logs", function() {
  ...
  it("a log stack frame with logging version and maven coordinates should turn into a nice source link", function() {
    ...
    expect(link).toEqual("at <a href='#/source/view/org.apache.karaf.shell:org.apache.karaf.shell.console:2.3.0.redhat-60015/org.apache.karaf.shell.console.jline.DelayedStarted/DelayedStarted.java?line=61'>org.apache.karaf.shell.console.jline.DelayedStarted.run</a>(<span class='fileName'>DelayedStarted.java</span>:<span class='lineNumber'>61</span>)[<span class='mavenCoords'>org.apache.karaf.shell:org.apache.karaf.shell.console:2.3.0.redhat-60015</span>]");
  });
});