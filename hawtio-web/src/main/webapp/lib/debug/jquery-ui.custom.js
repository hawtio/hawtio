...
$.widget("ui.mouse", {
	...
	_mouseMove: function(event) {
		...
		if ($.support.msie && !(document.documentMode >= 9) && !event.button) {
...
$.widget("ui.draggable", $.ui.mouse, {
	...
	_getParentOffset: function() {
		...
		|| (this.offsetParent[0].tagName && this.offsetParent[0].tagName.toLowerCase() == 'html' && $.support.msie)) //Ugly IE fix
			po = { top: 0, left: 0 };
	...
	_convertPositionTo: function(d, pos) {
		...
		return {
			top: (
				...
				- ($.support.safari && $.support.version < 526 && this.cssPosition == 'fixed' ? 0 : ( this.cssPosition == 'fixed' ? -this.scrollParent.scrollTop() : ( scrollIsRootNode ? 0 : scroll.scrollTop() ) ) * mod)
			),
			left: (
				pos.left																// The absolute mouse position
				+ this.offset.relative.left * mod										// Only for relative positioned nodes: Relative offset from element to offset parent
				+ this.offset.parent.left * mod											// The offsetParent's offset without borders (offset + border)
				- ($.support.safari && $.support.version < 526 && this.cssPosition == 'fixed' ? 0 : ( this.cssPosition == 'fixed' ? -this.scrollParent.scrollLeft() : scrollIsRootNode ? 0 : scroll.scrollLeft() ) * mod)
			)
		};
	...
	_generatePosition: function(event) {
		...
		return {
			top: (
				...
				+ ($.support.safari && $.support.version < 526 && this.cssPosition == 'fixed' ? 0 : ( this.cssPosition == 'fixed' ? -this.scrollParent.scrollTop() : ( scrollIsRootNode ? 0 : scroll.scrollTop() ) ))
			),
			left: (
				...
				+ ($.support.safari && $.support.version < 526 && this.cssPosition == 'fixed' ? 0 : ( this.cssPosition == 'fixed' ? -this.scrollParent.scrollLeft() : scrollIsRootNode ? 0 : scroll.scrollLeft() ))
			)
		};
...
$.widget("ui.resizable", $.ui.mouse, {
	...
	_mouseDrag: function(event) {
		...
		var data = trigger.apply(this, [event, dx, dy]), ie6 = $.support.msie && $.support.version < 7, csdif = this.sizeDiff;
	...
	_proportionallyResize: function() {
		...
		for (var i=0; i < this._proportionallyResizeElements.length; i++) {
			...
			if ($.support.msie && !(!($(element).is(':hidden') || $(element).parents(':hidden').length)))
				continue;
	...
	_renderProxy: function() {
		...
		if(this._helper) {
			...
			var ie6 = $.support.msie && $.support.version < 7, ie6offset = (ie6 ? 1 : 0),
			pxyoffset = ( ie6 ? 2 : -1 );
...
$.extend(Datepicker.prototype, {
	...
	_showDatepicker: function(input) {
		...
		if (isFixed && $.support.opera) { // correction for Opera when fixed and scrolled
	...
	_generateHTML: function(inst) {
		...
		html += buttonPanel + ($.support.msie && parseInt($.support.version,10) < 7 && !inst.inline ?
...
function isArray(a) {
	return (a && (($.support.safari && typeof a == 'object' && a.length) ||
