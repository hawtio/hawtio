...
public class DevServlet extends HttpServlet {
    ...
    static {
        String contentDirectory = System.getProperty("hawt.io.contentDirectory");
        if (contentDirectory != null && !contentDirectory.equals("")) {
            new Config().setContentDirectory(contentDirectory);
        }
    }
