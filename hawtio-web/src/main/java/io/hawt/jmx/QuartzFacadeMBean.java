...
public interface QuartzFacadeMBean {
     ...
     */
    void updateSimpleTrigger(String schedulerObjectName, String triggerName, String groupName,
     ...
     */
    void updateCronTrigger(String schedulerObjectName, String triggerName, String groupName,
